...
namespace GameServer
{
    class Server
    {
        ...
        public static void Start(int _maxPlayers, int _port)
        {
            ...
            Debug.Log($"Server: Server started on port {Port}.");
        }
        ...
        private static void TCPConnectCallback(IAsyncResult _result)
        {
            ...
            Debug.LogError($"Server: {_client.Client.RemoteEndPoint} failed to connect: Server full!");
        }
        ...
        private static void UDPReceiveCallback(IAsyncResult _result)
        {
            ...
            {
                Debug.LogError($"Server: Error receiving UDP data: {_ex}");
            }
        }
        ...
        public static void SendUDPData(IPEndPoint _clientEndPoint, Packet _packet)
        {
            ...
            {
                Debug.LogError($"Server: Error sending data to {_clientEndPoint} via UDP: {_ex}");
            }
        }
        ...
        private static void InitializeServerData()
        {
            ...
            packetHandlers = new Dictionary<int, PacketHandler>()
            {
                ...
                { (int)Packets.Pickup, ServerHandle.TCPDataReceived },
                { (int)Packets.DropItem, ServerHandle.TCPDataReceived }
            };
